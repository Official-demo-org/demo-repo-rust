...
// SAST: Hardcoded credentials — never store secrets in source code
const GITHUB_API_TOKEN: &str = "ghp_A1B2C3D4E5F6G7H8I9J0hardcodedTOKEN";
const DB_PASSWORD: &str = "Passw0rd!SuperSecret123";
const AWS_SECRET_ACCESS_KEY: &str = "wJalrXUtnFEMIK7MDENGbPxRfiCYEXAMPLEKEY";
